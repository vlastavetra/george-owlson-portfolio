  ...
  projects: [
    {
      id: "speedvpn",
      name: "SpeedVPN",
      works: "Research, Prototyping, Visual\u00A0Design, Animation",
      mainDescription: "Mobile application for VPN service",
      status: "released",
      slides: [
        {
          id: 1,
          src: "https://framerusercontent.com/images/wrlQeHbh3Hp9QXf8CGGYNZaCTQ.png",
        },
        {
          id: 2,
          src: "https://framerusercontent.com/images/M1B0FvxggHsIPFEeW7FIyOiUCU.png",
        },
      ],
    ...
    },
    {
      ...
      works: "Research, Prototyping, Visual\u00A0Design",
      mainDescription:
        "Mobile application that helps you find an interesting event that considering all sorts of factors like mood, exact time or place.",
      slides: [
        {
          id: 1,
          src: "https://thumb.tildacdn.com/tild6464-3237-4932-b436-313663306231/-/format/webp/divercity_cover_1.png",
        },
        {
          id: 2,
          src: "https://thumb.tildacdn.com/tild3962-3365-4266-b038-323231303365/-/format/webp/DC_feed_card_search.png",
        },
        {
          id: 3,
          src: "https://thumb.tildacdn.com/tild3366-3131-4166-b231-313537323536/-/format/webp/DC_regprofile.png",
        },
        {
          id: 4,
    ...
    },
    {
      ...
      works: "Research, Prototyping, Visual Design",
      mainDescription:
        "Mobile application for people who love delicious coffee, are always in a hurry and don't want to waste time by standing in queues",
      slides: [
        {
          id: 1,
    ...
    },
    {
      ...
      slides: [
        {
          id: 1,
          src: "https://thumb.tildacdn.com/tild3163-3031-4536-b332-346630666639/-/format/webp/alcon_cover.png",
        },
      ],
      button: "See more",
      buttonColor: "#003496",
    },
    {
      ...
      mainDescription: "",
      introImg:
        "https://thumb.tildacdn.com/tild6362-6438-4435-a337-386364346334/-/format/webp/main_page_graphics_c.png",
      slides: [
        {
          id: 1,
        ...
        },
        {
          ...
          text: "Retouch for Datsun / Broshure KV",
        },
      ],
    },
  ],
