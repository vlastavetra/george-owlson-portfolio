          ...
          <div className={styles.twoCollumn}>
            <div className={styles.textModule}>
              ...
              <p className={styles.text}>
                A coffee shop is opening soon for people who love delicious
                coffee, are always in a hurry and don&apos;t want to waste time
                by standing in queues
              </p>
              <h2 className={styles.title}>Idea</h2>
              <p className={styles.text}>
                Create a mobile application for order a coffee / desserts /
                sandwiches and pick it up at a coffee shop without a queue by
                number or code.
              </p>
              <h2 className={styles.title}>Conditions</h2>
              <ul className={styles.list}>
                <li>
                  User path from start the application to to the order&apos;s
                  confirmation as short as possible
                </li>
      ...
      <section className={styles.section}>
        ...
        <BigSubsection style={{ paddingTop: "60px" }}>
          <div className={styles.textModule}>
            ...
            <p className={styles.text}>
              During the study, a user journey map was compiled with the basic
              functionality of the application and possible improvements in
              future updates.
            </p>
          </div>
        </BigSubsection>
        ...
        <BigSubsection style={{ paddingTop: "100px" }}>
          <div className={styles.textModule}>
            ...
            <p className={styles.singleText}>
              Created a detailed scenario with possible errors while using the
              application.
            </p>
          </div>
          <img
      ...
      <section className={styles.section}>
        ...
        <BigSubsection style={{ paddingTop: "100px" }}>
          <div className={styles.textModule}>
            ...
            <p className={styles.text}>
              For the application&apos;s work, a simple registration is required
              using a phone number and specifying a name.
            </p>
          </div>
      ...
      <section className={styles.section}>
        ...
        <BigSubsection style={{ paddingTop: "100px" }}>
          <div className={styles.textModule}>
            ...
            <p className={styles.text}>
              It&apos;s carried out by searching through geolocation, selecting
              a place on the map, or searching through a list.
            </p>
          </div>
          <div className={styles.threeImgs}>
            <div>
      ...
      <section className={styles.section}>
        ...
        <BigSubsection style={{ paddingTop: "100px" }}>
          <div className={styles.textModule}>
            ...
            <p className={styles.text}>
              On the main page there are menus, filters, the name and address of
              the selected coffee shop, and there is also a button to repeat the
              previous order.
            </p>
            <p className={styles.text}>
              When choosing a coffee, the user goes to the customize drink page,
              where he can select the volume, additional ingredients, syrups and
              sugar.
            </p>
          </div>
          <img
